			...
			<div class="admin-content-body">
				...
				<div class="am-g">
					<div class="am-u-sm-12">
						<form:form  class="am-form am-form-horizontal" commandName="resource" method="post">
							<form:hidden path="id" />
							...
							<c:if test="${not empty parent}">
								<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" placeholder="" id="name" value="${parent.name}" readonly="readonly"/> 
									</div>
								</div>
							</c:if>
							<div class="am-form-group">
								<form:label class="am-u-sm-3 am-form-label" path="name"><c:if test="${not empty parent}">子</c:if>名称：</form:label>
								<div class="am-u-sm-9">
							...
							<div class="am-form-group">
								<form:label class="am-u-sm-3 am-form-label" path="type">类型：</form:label>
								<div class="am-u-sm-9">
									<form:select class="select" path="type" items="${types}" itemLabel="info" />
								</div>
							</div>
							
							<div class="am-form-group">
								<form:label class="am-u-sm-3 am-form-label" path="url">URL路径：</form:label>
								<div class="am-u-sm-9">
									<form:input class="input-text" path="url" />
								</div>
							</div>
								
							<div class="am-form-group">
								<form:label class="am-u-sm-3 am-form-label" path="permission">权限字符串：</form:label>
								<div class="am-u-sm-9">
									<form:input class="input-text" path="permission" />
								</div>
							</div>			
