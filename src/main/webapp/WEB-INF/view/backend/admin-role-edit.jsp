		...
		<div class="admin-content">
			<div class="admin-content-body">
				...
				<div class="am-u-sm-12">
					<form:form class="am-form am-form-horizontal" commandName="role" method="post">
						<form:hidden path="id" />
						<form:hidden path="available" />
						<div class="am-form-group">
							<form:label class="am-u-sm-3 am-form-label" path="role">角色名：</form:label>
							<div class="am-u-sm-9">
								<form:input type="text" placeholder="角色名 / role Name" path="role" />
							</div>
						</div>
						<div class="am-form-group">
							<form:label class="am-u-sm-3 am-form-label" path="description">角色名：</form:label>
							<div class="am-u-sm-9">
								<form:input type="text" placeholder="角色描述 / role description" path="description" />
							</div>
						</div>
						<div class="am-form-group">
							<form:label class="am-u-sm-3 am-form-label" path="resourceIds">拥有的资源列表：</form:label>
							<form:hidden path="resourceIds" />
							<div class="am-u-sm-9 am-input-group am-input-group-primary">
								<input type="text" id="resourceName" name="resourceName" value="${fn:resourceNames(role.resourceIds)}" readonly>
...
$(function () {
    ...
    var zNodes =[
        ...
        { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${fn:in(role.resourceIds, r.id)}},
        </c:if>
        </c:forEach>
    ];
