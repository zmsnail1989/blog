				...
				<div class="am-g">
					<div class="am-u-sm-12">
						<table width="100%"
							...
							<tbody>
								<c:forEach items="${roleList}" var="role" varStatus="obj">
									...
									<td><shiro:hasPermission name="role:update">
											<a title="修改"
												href="${pageContext.request.contextPath}/backend/role/${role.id}/update">
											...
											<a title="删除"
												href="${pageContext.request.contextPath}/backend/role/${role.id}/delete">
...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".am-icon-plus").parent().click(function(){
			window.location.href="/backend/role/create";
		});
	});
</script>
</html>