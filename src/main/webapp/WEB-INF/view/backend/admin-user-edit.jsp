			...
			<div class="admin-content-body">
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
						<form:form  class="am-form am-form-horizontal" commandName="user" method="post">
							<form:hidden path="id" />
							...
							<div class="am-form-group">
								<form:label for="user-name" class="am-u-sm-3 am-form-label" path="username">姓名 / Name</form:label>
								<div class="am-u-sm-9">
									<form:input type="text" placeholder="姓名 / Name" id="username" path="username"/> <small>输入你的名字，让我们记住你。</small>
								</div>
							</div>
							<c:if test="${op eq '新增'}">
							<div class="am-form-group">
								<form:label  class="am-u-sm-3 am-form-label" path="password">密码</form:label>
								<div class="am-u-sm-9">
									<form:input type="password"  placeholder="输入你的密码 / keyword" path="password"/> <small>密码你懂得...</small>
								</div>
							</div>
							</c:if>
							<div class="am-form-group">
								<form:label  class="am-u-sm-3 am-form-label" path="organizationId">所属组织：</form:label>
								<form:hidden path="organizationId" />
								<div class="am-u-sm-9">
								</div>
								
								<div class="am-u-sm-9 am-input-group am-input-group-primary">
								  <input type="text" id="organizationName" name="organizationName" placeholder="选择你的组织" value="${fn:organizationName(user.organizationId)}" readonly/>
									<span class="am-input-group-label" id="menuBtn"><i class="am-icon-windows am-icon-fw"></i></span>
								</div>
							</div>

							<div class="am-form-group">
								<form:label  class="am-u-sm-3 am-form-label" path="roleIds">角色列表：</form:label>
								<div class="am-u-sm-9">
									<form:select class="select" path="roleIds" items="${roleList}"
							...
							<div class="am-form-group">
								<div class="am-u-sm-9 am-u-sm-push-3">
									<form:button type="submit" class="am-btn am-btn-primary">${op}</form:button>
								</div>
							</div>
						</form:form>
					</div>
